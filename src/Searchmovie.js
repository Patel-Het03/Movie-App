...
export default function Moviesearch(){
    ...
    const searchMovie = async (e)=>{
        ...
        const url=`https://api.themoviedb.org/3/search/movie?api_key=304f54e615367bf37623f482a730bb9e&language=en-US&query=${query}&page=1& include_adult=false`;
            ...
            {/* <div className="card-list">
               {movies.filter(movie=>movie.poster_path).map(movie=>(
                   <div className="card" key={movie.id}>
                      ...
                      <p>
                         <small>RELEASE DATE:-{movie.release_data}</small>
                      </p>
                      <p>
